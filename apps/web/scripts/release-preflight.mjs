...
if (config.main !== "./apps/web/dist/server/entry.mjs") {
  failures.push("Wrangler main must point at ./apps/web/dist/server/entry.mjs");
}

if (config.assets?.directory !== "./apps/web/dist/client") {
  failures.push("Wrangler assets.directory must point at ./apps/web/dist/client");
}
